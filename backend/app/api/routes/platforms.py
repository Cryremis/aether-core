...
def _serialize_platform_summary(
    ...
    *,
    ...
    return PlatformSummary(
        ...
        sandbox_proxy_enabled=bool(row.get("sandbox_proxy_enabled")),
        sandbox_proxy_http=str(row.get("sandbox_proxy_http") or ""),
        sandbox_proxy_https=str(row.get("sandbox_proxy_https") or ""),
        sandbox_proxy_all=str(row.get("sandbox_proxy_all") or ""),
        sandbox_proxy_no_proxy=str(row.get("sandbox_proxy_no_proxy") or ""),
